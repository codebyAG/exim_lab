...
class _ExportJourneyScreenState extends State<ExportJourneyScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<JourneyProvider>().fetchJourney('export');
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final steps = journeyProvider.exportSteps;
              ...
              : ListView(
                  ...
                  children: [
                    const JourneyHeader(
                      ...
                      subtitle: 'Master your export business step-by-step',
                    ),
                    SizedBox(height: 3.h),
  ...
  void _advanceStep(int stepId) {
    context.read<JourneyProvider>().markStepCompleted('export', stepId);
