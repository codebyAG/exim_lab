...
class GalleryIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(flashRect, Radius.circular(3 * scale)),
      bodyPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(flashRect, Radius.circular(3 * scale)),
    ...
    final photo1 = Rect.fromCenter(
      center: Offset.zero,
      width: 22 * scale,
      height: 16 * scale,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(photo1, Radius.circular(2 * scale)),
      photoPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(photo1, Radius.circular(2 * scale)),
    ...
    final photo2 = Rect.fromCenter(
      center: Offset.zero,
      width: 20 * scale,
      height: 14 * scale,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(photo2, Radius.circular(2 * scale)),
      photoPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(photo2, Radius.circular(2 * scale)),
...
class ImportJourneyIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(75 * scale, 18 * scale),
        width: 32 * scale,
        height: 18 * scale,
      ),
      cloudPaint,
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(86 * scale, 20 * scale),
        width: 20 * scale,
        height: 14 * scale,
      ),
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(45 * scale, 25 * scale),
        width: 72 * scale,
        height: 16 * scale,
      ),
      fuselagePaint,
...
class ExportJourneyIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
      waterPath,
      Paint()..color = const Color(0xFF1040C1).withValues(alpha: 0.5),
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(22 * scale, 42 * scale, 66 * scale, 16 * scale),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(35 * scale, 32 * scale, 40 * scale, 12 * scale),
        Radius.circular(2 * scale),
      ),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(24 * scale, 44 * scale, 14 * scale, 10 * scale),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(40 * scale, 44 * scale, 14 * scale, 10 * scale),
        Radius.circular(1 * scale),
      ),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(56 * scale, 44 * scale, 14 * scale, 10 * scale),
        Radius.circular(1 * scale),
      ),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(72 * scale, 44 * scale, 12 * scale, 10 * scale),
        Radius.circular(1 * scale),
      ),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(52 * scale, 18 * scale, 6 * scale, 16 * scale),
        Radius.circular(2 * scale),
      ),
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(58 * scale, 12 * scale),
        width: 12 * scale,
        height: 8 * scale,
      ),
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(62 * scale, 7 * scale),
        width: 8 * scale,
        height: 6 * scale,
      ),
...
class ExportPriceIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(4 * scale, 4 * scale, 24 * scale, 24 * scale),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(8 * scale, 8 * scale, 7 * scale, 5 * scale),
        Radius.circular(1 * scale),
      ),
      itemPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(17 * scale, 8 * scale, 7 * scale, 5 * scale),
        Radius.circular(1 * scale),
      ),
      itemPaint,
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(8 * scale, 15 * scale, 7 * scale, 4 * scale),
        Radius.circular(1 * scale),
      ),
      itemPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(17 * scale, 15 * scale, 7 * scale, 4 * scale),
        Radius.circular(1 * scale),
      ),
      itemPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(17 * scale, 21 * scale, 7 * scale, 4 * scale),
        Radius.circular(1 * scale),
      ),
      itemPaint,
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(8 * scale, 21 * scale, 7 * scale, 4 * scale),
        Radius.circular(1 * scale),
      ),
      Paint()..color = const Color(0xFFFFD000),
    );
...
class LogisticsIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(2 * scale, 12 * scale, 18 * scale, 12 * scale),
        Radius.circular(2 * scale),
      ),
      paint,
    );
...
class BuyerIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      ...
      12 * scale,
      Paint()..color = const Color(0xFF7A4400),
    );
...
class MasterclassShipWatermarkPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(30 * scale, 48 * scale, 100 * scale, 22 * scale),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(50 * scale, 32 * scale, 60 * scale, 18 * scale),
        Radius.circular(3 * scale),
      ),
      paint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(65 * scale, 18 * scale, 30 * scale, 16 * scale),
        Radius.circular(2 * scale),
      ),
      paint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(74 * scale, 6 * scale, 10 * scale, 18 * scale),
        Radius.circular(2 * scale),
      ),
      paint,
    );
...
class CourseChecklistPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final docRect = RRect.fromRectAndRadius(
      Rect.fromLTWH(52 * scale, 18 * scale, 40 * scale, 50 * scale),
      Radius.circular(4 * scale),
    );
    ...
    void drawLine(double x, double y, double w, double alpha) {
      ...
      canvas.drawRRect(
        RRect.fromRectAndRadius(
          Rect.fromLTWH(x * scale, y * scale, w * scale, 3 * scale),
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(120 * scale, 25 * scale),
        width: 16 * scale,
        height: 36 * scale,
      ),
      globePaint,
...
class CourseForexPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Floating dots
    canvas.drawCircle(
      Offset(130 * scale, 22 * scale),
      8 * scale,
      Paint()..color = const Color(0xFFFF8888).withValues(alpha: 0.3),
    );
    canvas.drawCircle(
      Offset(140 * scale, 70 * scale),
      6 * scale,
      Paint()..color = const Color(0xFFFF8888).withValues(alpha: 0.2),
    );
  }
...
class CourseBuyersPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      Offset(80 * scale, 62 * scale),
      6 * scale,
      Paint()..color = const Color(0xFFFFD000).withValues(alpha: 0.8),
    );
    ...
    canvas.drawLine(
      Offset(30 * scale, 75 * scale),
      Offset(80 * scale, 62 * scale),
      netPaint,
    );
    canvas.drawLine(
      Offset(130 * scale, 75 * scale),
      Offset(80 * scale, 62 * scale),
      netPaint,
    );
  }
...
class PopularCertPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = const Color(0xFF1040C1);
    final docRect = RRect.fromRectAndRadius(
      Rect.fromLTWH(16 * scale, 12 * scale, 32 * scale, 40 * scale),
      Radius.circular(3 * scale),
    );
    canvas.drawRRect(docRect, paint);
    canvas.drawRRect(
    ...
    void drawLine(double y, double w, double alpha) {
      ...
      canvas.drawRRect(
        RRect.fromRectAndRadius(
          Rect.fromLTWH(20 * scale, y * scale, w * scale, 3 * scale),
          Radius.circular(1.5 * scale),
        ),
        linePaint,
      );
...
class PopularFinancePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      Offset(32 * scale, 30 * scale),
      16 * scale,
      Paint()..color = const Color(0xFF8B000C),
    );
    canvas.drawCircle(
      Offset(32 * scale, 30 * scale),
      16 * scale,
    ...
    canvas.drawLine(
      Offset(20 * scale, 50 * scale),
      Offset(44 * scale, 50 * scale),
      Paint()
        ..color = const Color(0xFFFF8888).withValues(alpha: 0.5)
        ..strokeWidth = 2 * scale
        ..strokeCap = StrokeCap.round,
    );
  }
...
class PopularLogisticsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
      Path()
        ..moveTo(12 * scale, 40 * scale)
        ..lineTo(52 * scale, 40 * scale)
        ..lineTo(50 * scale, 48 * scale)
        ..lineTo(14 * scale, 48 * scale)
        ..close(),
      Paint()..color = const Color(0xFFC8D8FF),
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(18 * scale, 30 * scale, 28 * scale, 12 * scale),
        Radius.circular(2 * scale),
      ),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(24 * scale, 22 * scale, 16 * scale, 10 * scale),
        Radius.circular(1 * scale),
      ),
      Paint()..color = const Color(0xFFC8D8FF),
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(20 * scale, 32 * scale, 8 * scale, 6 * scale),
        Radius.circular(1 * scale),
      ),
      Paint()..color = const Color(0xFFFF2D35),
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(30 * scale, 32 * scale, 8 * scale, 6 * scale),
        Radius.circular(1 * scale),
      ),
      Paint()..color = const Color(0xFFFFD000),
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(40 * scale, 32 * scale, 8 * scale, 6 * scale),
        Radius.circular(1 * scale),
      ),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(30 * scale, 14 * scale, 4 * scale, 10 * scale),
        Radius.circular(1 * scale),
      ),
...
class PopularMarketPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(32 * scale, 32 * scale),
        width: 12 * scale,
        height: 40 * scale,
      ),
      gridPaint,
    ...
    canvas.drawLine(
      Offset(12 * scale, 32 * scale),
      Offset(52 * scale, 32 * scale),
      gridPaint,
    );
...
class SIIEALogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(18 * scale, 18 * scale),
        width: 14 * scale,
        height: 32 * scale,
      ),
      linePaint,
    ...
    final equatorPaint = Paint()
      ..color = const Color(0xFF88AAFF).withValues(alpha: 0.5)
      ..strokeWidth = 1 * scale;
    canvas.drawLine(
      Offset(2 * scale, 18 * scale),
      Offset(34 * scale, 18 * scale),
      equatorPaint,
    );
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(12 * scale, 13 * scale),
        width: 8 * scale,
        height: 6 * scale,
      ),
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(22 * scale, 12 * scale),
        width: 10 * scale,
        height: 6 * scale,
      ),
      continentPaint..color = const Color(0xFF3A8C3A).withValues(alpha: 0.7),
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(23 * scale, 20 * scale),
        width: 7 * scale,
        height: 8 * scale,
      ),
...
class QuizTopicPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final sparklePaint = Paint()
      ..color = const Color(0xFFFFD000).withValues(alpha: 0.6);
    canvas.drawCircle(
      Offset(centerX - 22 * scale, centerY - 20 * scale),
      2.5 * scale,
      sparklePaint,
    );
    canvas.drawCircle(
      Offset(centerX + 25 * scale, centerY + 10 * scale),
      2 * scale,
      sparklePaint,
    );
    canvas.drawCircle(
      Offset(centerX + 5 * scale, centerY - 35 * scale),
      1.5 * scale,
      sparklePaint,
    );
    ...
    final nodePaint = Paint()
      ...
      ..strokeWidth = 1 * scale;
    canvas.drawLine(
      Offset(centerX - 25 * scale, centerY + 20 * scale),
      Offset(centerX - 10 * scale, centerY + 10 * scale),
      nodePaint,
    );
    canvas.drawLine(
      Offset(centerX + 25 * scale, centerY - 20 * scale),
...
class AiExpertPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final headRect = Rect.fromCenter(
      center: Offset(centerX, centerY + 5 * scale),
      width: 44 * scale,
      height: 36 * scale,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(headRect, Radius.circular(8 * scale)),
      headPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(headRect, Radius.circular(8 * scale)),
    ...
    for (int i = 0; i < 3; i++) {
      ...
      canvas.drawCircle(
        Offset(centerX - 15 * scale + (i * 15 * scale), centerY - 28 * scale),
        2 * scale,
        Paint()..color = const Color(0xFF1E5FFF).withValues(alpha: 0.3),
      );
    }
    ...
    canvas.drawRect(
      Rect.fromCenter(
        center: Offset(centerX, centerY + 13 * scale),
        width: 14 * scale,
        height: 1.5 * scale,
      ),
      soundPaint,
...
class HsnFinderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(20 * scale, -4 * scale, 30 * scale, 8 * scale),
        Radius.circular(4 * scale),
      ),
      paint,
    );
    ...
    canvas.drawRect(
      Rect.fromLTWH(25 * scale, 35 * scale, 12 * scale, 2 * scale),
      textPaint,
    );
    canvas.drawRect(
      Rect.fromLTWH(42 * scale, 35 * scale, 12 * scale, 2 * scale),
      textPaint,
    );
    canvas.drawRect(
      Rect.fromLTWH(30 * scale, 45 * scale, 20 * scale, 2 * scale),
      textPaint,
    );
  }
...
class CbmCalculatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final linePaint = Paint()
      ...
      ..strokeWidth = 1 * scale;
    canvas.drawLine(
      Offset(10 * scale, 35 * scale),
      Offset(10 * scale, 70 * scale),
      linePaint,
    );
    canvas.drawLine(
      Offset(5 * scale, 35 * scale),
      Offset(15 * scale, 35 * scale),
      linePaint,
    );
    canvas.drawLine(
      Offset(5 * scale, 70 * scale),
      Offset(15 * scale, 70 * scale),
      linePaint,
    );
  }
...
class GstCalculatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(20 * scale, 15 * scale, 60 * scale, 70 * scale),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(28 * scale, 25 * scale, 44 * scale, 15 * scale),
        Radius.circular(2 * scale),
      ),
    ...
    for (int r = 0; r < 3; r++) {
      for (int c = 0; c < 3; c++) {
        canvas.drawCircle(
          Offset(32 * scale + (c * 18 * scale), 50 * scale + (r * 12 * scale)),
          4 * scale,
          btnPaint,
        );
      }
...
class GovBenefitsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Building
    canvas.drawRect(
      Rect.fromLTWH(20 * scale, 45 * scale, 60 * scale, 35 * scale),
      paint,
    );
...
class IncotermsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final linePaint = Paint()
      ...
      ..strokeWidth = 1.5 * scale;
    canvas.drawLine(
      Offset(25 * scale, 45 * scale),
      Offset(40 * scale, 40 * scale),
      linePaint,
    );
    canvas.drawLine(
      Offset(25 * scale, 55 * scale),
