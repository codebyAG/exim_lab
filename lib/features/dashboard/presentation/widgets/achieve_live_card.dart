                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildAchieveItem("Start your export business"),
                      _buildAchieveItem("Find international buyers"),
                      _buildAchieveItem("Calculate profit margins"),
                      _buildAchieveItem("Handle global shipping"),
                    ],
                  ),
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text: "LIVE",
                                  style: TextStyle(color: const Color(0xFFFF4444)),
                                ),
                              ],
                            ),
                          ),
                      ...
                      Row(
                        children: [
                          Icon(Icons.calendar_month_rounded, color: Colors.white54, size: 14.sp),
                          SizedBox(width: 2.w),
                          Text(
                            "7:00 PM",
                            style: TextStyle(
